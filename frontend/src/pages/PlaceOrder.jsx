...
function PlaceOrder() {
  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:14 min-h-[80vh] border-t ' >
     ...
     <div className='flex flex-col gap-4 w-full sm:max-w-[480px] ' >
          ...
          <input className='border border-gray-300 rounded w-full py-1.5 px-3.5  ' type="email" placeholder='Enter Email ' />
