...
function Collection() {
  ...
  {/** check if value exists in array then "remove it" else "add it"  */}
  ...
  const toggleSubCategory = (e)=>{
    ...
    const sortProducts=()=>{
      'yaha pr filterProducts category se filer ho kr aa rhe hai isiliye hmne ek copy banyi hai'
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t' >
       ...
       <p onClick={()=>{setShowFilter(!showFilter)}} className='flex items-center gap-2 cursor-pointer text-xl my-2'>FILTERS
